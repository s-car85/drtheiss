            ...
            <div class="post">
                @if($post->post_image != null)
                    <a href="{{ url('blog/'.$post->slug) }}">
                        <div class="post-image" style="background: url('{{ asset($post->post_image) }}');background-size: auto 200px ;	background-repeat: no-repeat;"></div>
                    </a>
                @endif
                <div class="post-sub">
                    ...
                    <div class="post-read-more">
                        <a href="{{ url('blog/'.$post->slug) }}" class="button-button-xsmall">Pročitaj više</a>
                    </div>
