...
@section('title')
    {{ trans('admin_message.sidebar.lecture') }}
@endsection
...
@section('content')
    ...
    <a href="{{ url('admin/lectures/archive') }}" class="btn btn-flat btn-info"><i class="fa fa-file-archive-o"></i> {{ trans('admin_message.lectures.archive') }}</a>

    <br>  <br>

    <form action="{!! route('admin.lectures.archiveall') !!}" method="POST"
          onsubmit="return confirm('{!! trans('admin_message.lectures.confirmarchive') !!}')">
        <input type="hidden" name="_method" value="POST">
        <input type="hidden" name="_token" value="{!! csrf_token() !!}">
        <input class="btn btn-sm btn-flat btn-danger"
               type="submit"
               value="{{ trans('admin_message.lectures.archiveall') }}">
    </form>
    ...
    <script>
        $(function() {
            ...
            var table = $('#lectures-table').DataTable({
                ...
                ajax: '{!! route('admin.lectures.data') !!}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
                    ...
                    {data: 'foundation', name: 'foundation', searchable: false},
